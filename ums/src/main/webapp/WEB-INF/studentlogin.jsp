...
<div class="form-group"  style="margin-left:100px;margin-right:100px;" ><label for="Username"><big>Username:</big></label>
<input type="text" class="form-control" placeholder="name"  name="name"/> </div>

<div class="form-group"  style="margin-left:100px;margin-right:100px;"><label for="password">password:</label>
