...
<ul>
	...
	<li><a href="${pageContext.request.contextPath}/choice?operation=aboutus" class="btn btn-primary btn-md">ABOUT PUST MC</a></li>
	<li><a href="${pageContext.request.contextPath}/choice?operation=findAjob" class="btn btn-primary btn-md">JOIN PUST MC</a></li>
</ul>
</div>
...
<a href="#"><i class="fa  fa-twitter fa-3x"></i> PUSTMC twitter</a>
</div>
	<li class="active" ><a href="https://www.facebook.com/"><i class="fa  fa-facebook-official fa-3x"></i>Follow PUSTMC facebook</a></li>
...
<h1><p style="color:white;"> <img class="plogo" src="<c:url value="static/theme/logopust.jpg" />"/> MEDICAL CENTER OF</p></h1>
<h1> <p style="color:white;">PABNA UNIVRRSITY OF SCIENCE AND TECHNOLOGY</p></h1>
</div>
...
<div id="find" class="tabcontent" align="center" >
  ...
  <p>SEARCH FOR A NEW JOB .START A NEW JOB IN PUST MC</p>
</div>
...
<div id="contact" class="tabcontent" align="center">
  ...
  <p>CONTACT TO OUR ADMIN FOR ANY PROBLM OR REPORTING ISSUE ABOUT PUST MC</p> 
</div>
...
<div id="job" class="tabcontent" align="center" >
  ...
  <p >PUST MC PROVIDE SUPPORT FOR YOU. CONTACT WITH US </p>
</div>

<div class="continer">
	<div id="slider_image1"  align="center">
	<img class="img5" src="<c:url value="static/theme/hd1.jpg" />"/>
	<img class="img5" src="<c:url value="static/theme/ncamp5.jpg" />"/>
	<img class="img5" src="<c:url value="static/theme/ncamp6.jpg" />"/>
	<img class="img5" src="<c:url value="static/theme/hd5.jpg" />"/>
...
<div class="container">
  <div class="row">
    ...
    <h1><a href="#" class="btn btn-success btn-lg">PUSTMC</a></h1>
      <p style="color:black; font-size:20px;">out pabna university of science and tehology 
      is a new University. it will now serve from eduction to 
       all kind of service</p>
    </div>
    <div class="col" style="background-color:gray;">
    <h1><a href="#" class="btn btn-success btn-lg">pustmc services</a></h1>
   ...
   of future students.
    ...
    <div class="col"  style="background-color:bisque;">
    <h1><a href="#" class="btn btn-success btn-lg">pustmc technology</a></h1>
   <p style="color:black; font-size:20px;">Medical center of pabna university has taken a good step and that step is to 
   ...
   i brings all liknd of new technology for mdical service</p>
    ...
    <div class="col"  style="background-color:gray;">
     <h1><a href="#" class="btn btn-success btn-lg">Research</a></h1>
      <p style="color:yellow; font-size:20px;">Our PUST medical center always support for reasearching. it allways keen to invent new thing a new solution a new medicine.
