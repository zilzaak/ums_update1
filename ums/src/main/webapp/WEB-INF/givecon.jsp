...
function calltaj(){
		...
		x["date"] = $("#date").val();
			...
			success: function(r){
				$("#divshow").show();
				 		$("#tn").text(r.testname);$("#pn").text(r.nameofp);
				 		$("#dt").text(r.date);$("#idd").text(r.idofd);
				 		$("#idp").text(r.idofp);
			               },
			                error: function(e){
			               	alert("fail to post");
...
<tr>
<td>
 <input type="hidden"    name="idofp" id="idofp" value="${giver}" /> </td>
</tr>
<tr>
<td>
 <input type="hidden"    name="idofd" id="idofd" value="${accepter}" /> </td>
</tr>
